"""Core-01 SE: data_migration_fix verify.py"""
...
def main():
    ...
    for path in ["src/migrate.py", "CHANGELOG.md"]:
    ...
    if cl.exists():
        results["changelog_updated"] = "migrat" in cl.read_text().lower() or "zip" in cl.read_text().lower() or "fix" in cl.read_text().lower()
