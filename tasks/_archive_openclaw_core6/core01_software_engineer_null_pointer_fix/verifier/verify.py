"""Core-01 SE: null_pointer_fix verify.py"""
...
def main():
    ...
    for path in ["src/user_config.py", "CHANGELOG.md"]:
    ...
    if cl.exists():
        ...
        results["changelog_updated"] = "null" in content or "preferences" in content or "fix" in content
